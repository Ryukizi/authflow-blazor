...
Sistema de autenticação e gerenciamento de usuários desenvolvido com C# / .NET e Blazor, utilizando Supabase como backend.
...
Estrutura pensada para facilitar manutenção, escalabilidade e legibilidade do código
